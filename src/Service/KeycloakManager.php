...
{
    public function __construct(private string $clientId, private KeycloakAdminClient $keycloakAdminClient, #[Target('cache.keycloak_manager')] private CacheInterface $cache) {}
